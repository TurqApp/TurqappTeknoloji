 ...
 */
exports.recordViewBatch = functions
    .region("europe-west1")
    ...
    for (const item of items) {
        ...
        const shardRef = db
            ...
            .doc(String(shardIdx));
        batch.set(shardRef, { goruntulenmeSayisi: admin.firestore.FieldValue.increment(count) }, { merge: true });
    }
    await batch.commit();
 ...
 */
exports.aggregateCounterShards = functions
    .region("europe-west1")
    ...
    const fields = ["goruntulenmeSayisi", "begeniSayisi"];
    ...
    for (const chunk of chunks) {
        ...
        for (const shardRef of chunk) {
            ...
            reset.updatedAt = admin.firestore.FieldValue.delete();
            wb.set(shardRef, reset, { merge: true });
        }
        await wb.commit();
    }
    console.log(`aggregateCounterShards: ${totals.size} post güncellendi, ${shardRefs.length} shard sıfırlandı`);
    return null;
});
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 */
exports.initCounterShards = functions
    .region("europe-west1")
...
//# sourceMappingURL=counterShards.js.map