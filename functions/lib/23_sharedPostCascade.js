...
exports.cascadeDeleteSharedPosts = void 0;
...
exports.cascadeDeleteSharedPosts = (0, firestore_1.onDocumentUpdated)({
    ...
    const postSharersSnap = await db
        ...
        .get();
    const sharedPostRefs = await Promise.all(postSharersSnap.docs.map(async (doc) => {
