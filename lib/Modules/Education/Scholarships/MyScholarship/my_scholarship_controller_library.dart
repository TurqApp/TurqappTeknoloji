...
part 'my_scholarship_controller_base_part.dart';
part 'my_scholarship_controller_class_part.dart';
part 'my_scholarship_controller_facade_part.dart';
part 'my_scholarship_controller_fields_part.dart';
