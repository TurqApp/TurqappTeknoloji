...
import 'package:turqappv2/Modules/Education/CikmisSorular/CikmisSorularRoad.dart';
...
class CikmisSorularGrid extends StatefulWidget {
  ...
  CikmisSorularGrid({super.key, required this.anaBaslik, required this.color});
  @override
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [widget.color, Colors.black.withOpacity(0.9)],
