...
import 'package:turqappv2/Modules/Story/StoryViewer/StoryContentProfiles/StoryContentProfiles.dart';
import 'package:turqappv2/Modules/Story/StoryViewer/StorySeens/StorySeensController.dart';
import '../../../../Core/EmptyRow.dart';

class StorySeens extends StatelessWidget {
  String storyID;
  StorySeens({super.key, required this.storyID});
  late StorySeensController controller;
  @override
  Widget build(BuildContext context) {
    controller = Get.put(StorySeensController(), tag: storyID);
