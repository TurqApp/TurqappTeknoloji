                  ...
                  return GestureDetector(
                    ...
                    child: Row(
                      children: [
                        ...
                        RozetContent(size: 18, userID: userID),
                      ],
                    ),
                  );
                }),
                  ...
                  NotificationListener<ScrollEndNotification>(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isLast = index == 0; // çünkü liste reverse: true
            ...
            PullDownButton(
              itemBuilder: (context) => [
                ...
                PullDownMenuItem(
                  onTap: () {
                    controller
                        .selectContact(); // ChatController içinde userID zaten var
                  },
                  title: 'Kişi Seç',
            ...
            Expanded(
              child: ConstrainedBox(
                constraints: const BoxConstraints(
                  maxHeight: 70, // Maksimum yükseklik sınırı
                  minHeight: 35, // Minimum yükseklik
                ),
                child: Container(
                  decoration: BoxDecoration(
                    color: Colors.white,
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      isCollapsed: true, // 👈 Bunu false yapıyoruz
                      contentPadding: EdgeInsets.symmetric(
                        vertical: 5,
                      ), // 👈 Dikey padding ekliyoruz
                    ),
