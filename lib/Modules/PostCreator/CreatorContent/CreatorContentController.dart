...
import '../../../Core/UploadConstants.dart';
...
class CreatorContentController extends GetxController {
  ...
  Future<void> pickImage() async {
    ...
    if (remaining <= 0) {
      UploadValidationService.showValidationError(
          'Maksimum ${UploadConstants.maxImagesPerPost} fotoğraf seçebilirsiniz.');
      return;
    }
  ...
  Future<void> openThumbnailPicker() async {
    ...
    final double sliderMax = (totalMs > 0 ? totalMs : 1).toDouble();
