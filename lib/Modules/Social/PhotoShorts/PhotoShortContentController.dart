...
import '../../../Services/ReshareHelper.dart';
import '../../../Services/PostCountManager.dart';
import '../../../Services/PostInteractionService.dart';
import '../../Agenda/AgendaController.dart';
import '../../Profile/MyProfile/ProfileController.dart';
import '../../ShareGrid/ShareGrid.dart';
import '../../Short/ShortController.dart';
import '../Comments/PostComments.dart';
import '../../../Services/PostDeleteService.dart';
...
class PhotoShortsContentController extends GetxController {
  ...
  Future<void> sikayetEt() async {
    try {
      ...
      final bool yeniDurum = !(model.sikayetEdildi ?? model.sikayetEdildi);
