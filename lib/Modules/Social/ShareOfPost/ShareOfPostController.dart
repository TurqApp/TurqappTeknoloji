...
import 'package:turqappv2/Core/Helpers/GlobalLoader/GlobalLoaderController.dart';
...
import 'package:turqappv2/Modules/Social/ShareOfPost/VideoCoverSelector.dart';
...
class ShareOfPostController extends GetxController {
  ...
  Future<void> _generateThumbnails() async {
    ...
    final durationMs = metadata.duration ?? 0;
  ...
  Future<void> _initializeNSFWDetector() async {
    nsfwDetector = await NsfwDetector.load();
  }
