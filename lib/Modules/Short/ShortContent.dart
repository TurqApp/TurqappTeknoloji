...
import 'package:turqappv2/Modules/Social/Comments/PostComments.dart';
...
import 'ShortContentController.dart';
  ...
  Widget pulldownmenu(BuildContext context) {
    return PullDownButton(
      itemBuilder: (context) => [
        PullDownMenuItem(
          onTap: () async {
            ...
            if (model.originalUserID.isNotEmpty) {
              ...
              finalOriginalPostID = model.originalPostID ?? model.docID;
            } else {
        ...
        PullDownMenuItem(
          onTap: () {
            Share.share("https://www.turqapp.com/posts/${model.docID}");
          },
          title: 'Paylaş',
