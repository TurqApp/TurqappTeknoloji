...
extension AgendaControllerFieldsPart on AgendaController {
  ...
  bool get isFeedRefreshBusy =>
      _feedRefreshInFlight || _startupChunkApplyInFlight || isLoading.value;
  bool get debugFeedRefreshInFlight => _feedRefreshInFlight;
  ...
  DateTime? get _feedRefreshPlaybackLockedAt =>
      _state.feedRefreshPlaybackLockedAt;
  set _feedRefreshPlaybackLockedAt(DateTime? value) =>
      _state.feedRefreshPlaybackLockedAt = value;
