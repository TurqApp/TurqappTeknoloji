...
import 'package:turqappv2/Core/Helpers/ClickableTextContent.dart';
...
import 'package:turqappv2/Modules/Social/UrlPostMaker/UrlPostMaker.dart';
import 'package:turqappv2/Modules/Social/PostSharers/PostSharers.dart';
...
import '../Common/ReshareAttribution.dart';
import '../Common/PostActionStyle.dart';
import 'AgendaContentController.dart';
  ...
  Widget mainbody() {
    return Column(
      ...
      children: [
        headerUserInfoBar(),
        // Metin varsa göster
        if (widget.model.metin.isNotEmpty)
          Padding(
                            ...
                            SizedBox.expand(
                              child: GestureDetector(
                                onTap: () async {
                                  if (widget.isPreview) {
                                    // Mevcut pozisyonu al
                                    Duration? currentPos = videoController?.value.position;

                                    if (currentPos == null || currentPos == Duration.zero) {
                                    ...
                                    if (controller.model.floodCount > 1) {
                                      ...
                                      if (widget.shouldPlay) videoController?.play();
                                    } else {
