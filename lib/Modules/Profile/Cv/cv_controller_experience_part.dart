...
extension CvControllerExperiencePart on CvController {
    ...
    _showExperienceSheet(
      ...
      onSave: () {
        if (firmaAdi.text.trim().isEmpty || pozisyon.text.trim().isEmpty) {
          AppSnackbar(
            'cv.missing_field'.tr,
            'cv.missing_company_position'.tr,
          );
          return;
        }
        ...
        isDeneyimleri.add(
          CVExperinceModel(
            ...
            year2: halenCalisiyorum.value ? 'cv.ongoing'.tr : yil2.text.trim(),
