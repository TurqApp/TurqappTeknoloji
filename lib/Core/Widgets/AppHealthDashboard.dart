...
import '../Services/NetworkAwarenessService.dart';
import '../Services/UploadQueueService.dart';
import '../Services/DraftService.dart';
import '../Services/PostEditingService.dart';
import '../Services/MediaEnhancementService.dart';
  ...
  Widget _buildKpiAlertCard() {
    ...
    return Card(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: (hasAlert ? Colors.red : Colors.green).withOpacity(0.08),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: (hasAlert ? Colors.red : Colors.green).withOpacity(0.25),
          ),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
