  ...
  List<MarketItemModel> sampleItems() {
    return <MarketItemModel>[
      MarketItemModel(
        ...
        description: 'Temiz kullanildi, kutulu.',
        price: 28450,
        currency: 'TRY',
        categoryKey: 'elektronik/telefon/iphone-ios-telefon',
        categoryPath: const ['Elektronik', 'Telefon', 'iPhone iOS Telefon'],
        locationText: 'Kadikoy, Istanbul',
        city: 'Istanbul',
        district: 'Kadikoy',
        coverImageUrl: '',
        imageUrls: const [],
        sellerName: 'Turq Kullanici',
      ...
      MarketItemModel(
        ...
        description: 'Pil sagligi iyi, kozmetik temiz.',
        price: 23900,
        currency: 'TRY',
        categoryKey: 'elektronik/bilgisayar/dizustu-bilgisayar',
        categoryPath: const ['Elektronik', 'Bilgisayar', 'Dizustu Bilgisayar'],
      ...
      MarketItemModel(
        ...
        description: 'Az kullanildi, yipranma yok.',
        price: 4200,
        currency: 'TRY',
        categoryKey: 'ev-yasam/mobilya/calisma-koltugu',
        categoryPath: const ['Ev & Yasam', 'Mobilya', 'Calisma Koltugu'],
        locationText: 'Cankaya, Ankara',
        city: 'Ankara',
        district: 'Cankaya',
        coverImageUrl: '',
        imageUrls: const [],
      ...
      MarketItemModel(
        ...
        title: 'Nike Kosu Ayakkabisi 42',
        description: 'Kutulu, az kullanildi.',
        price: 2650,
        currency: 'TRY',
        categoryKey: 'spor/ayakkabi/kosu-ayakkabisi',
        categoryPath: const ['Spor', 'Ayakkabi', 'Kosu Ayakkabisi'],
        locationText: 'Konak, Izmir',
        city: 'Izmir',
        district: 'Konak',
        coverImageUrl: '',
        imageUrls: const [],
