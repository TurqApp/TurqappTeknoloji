...
| ART-025 | T-023B | ads center application service notu ve hedefli delegasyon testleri | `docs/architecture/T-023B_ADS_CENTER_USECASE_PILOT_2026-03-28.md` + `test/unit/modules/profile/ads_center_application_service_test.dart` | `dart analyze --no-fatal-warnings lib/Modules/Profile/Settings/AdsCenter/ads_center_application_service.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_library.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_base_part.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_class_part.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_fields_part.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_actions_part.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_stream_part.dart test/unit/modules/profile/ads_center_application_service_test.dart` + `flutter test test/unit/modules/profile/ads_center_application_service_test.dart` + `bash scripts/check_architecture_guards.sh --against HEAD --files ...` | Codex local review | Hazir |
...
| ART-028 | T-023C | chat conversation application service notu ve send/read policy testleri | `docs/architecture/T-023C_CHAT_USECASE_CIKARIMI_2026-03-28.md` + `test/unit/modules/chat_conversation_application_service_test.dart` | `dart analyze --no-fatal-warnings lib/Modules/Chat/chat_conversation_application_service.dart lib/Modules/Chat/chat_controller.dart lib/Modules/Chat/chat_controller_base_part.dart lib/Modules/Chat/chat_controller_shell_part.dart lib/Modules/Chat/chat_controller_fields_part.dart lib/Modules/Chat/chat_controller_send_part.dart lib/Modules/Chat/chat_controller_actions_part.dart lib/Modules/Chat/chat_controller_conversation.dart test/unit/modules/chat_conversation_application_service_test.dart` + `flutter test test/unit/modules/chat_conversation_application_service_test.dart` + `bash scripts/check_architecture_guards.sh --against HEAD --files ...` | Codex local review | Hazir |
| ART-029 | T-028 | runtime boundary notu ve upload/network/device-session delegasyon testleri | `docs/architecture/T-028_RUNTIME_BOUNDARY_2026-03-28.md` + `lib/Runtime/feature_runtime_services.dart` + `test/unit/modules/runtime_feature_services_test.dart` | `dart analyze --no-fatal-warnings lib/Runtime/feature_runtime_services.dart lib/Modules/SignIn/sign_in_application_service.dart lib/Modules/SignIn/sign_in_controller.dart lib/Modules/SignIn/sign_in_controller_support_part.dart lib/Modules/SignIn/sign_in_controller_auth_part.dart lib/Modules/PostCreator/post_creator_controller.dart lib/Modules/PostCreator/post_creator_controller_support_part.dart lib/Modules/PostCreator/post_creator_controller_flow_part.dart lib/Modules/PostCreator/CreatorContent/creator_content_controller.dart lib/Modules/PostCreator/CreatorContent/creator_content_controller_media_part.dart lib/Modules/Splash/splash_post_login_warmup.dart lib/Modules/Splash/splash_view.dart lib/Modules/Splash/splash_view_warm_part.dart lib/Modules/Splash/splash_dependency_registrar.dart lib/Modules/Profile/Settings/settings.dart lib/Modules/Profile/Settings/settings_diagnostics_usage_part.dart lib/Modules/Profile/Settings/settings_diagnostics_actions_part.dart lib/Modules/Profile/Settings/permissions_view.dart lib/Modules/Profile/Settings/permissions_view_playback_part.dart test/unit/modules/runtime_feature_services_test.dart` + `flutter test test/unit/modules/runtime_feature_services_test.dart` + `bash scripts/check_architecture_guards.sh --against HEAD --files ...` | Codex local review | Hazir |
| ART-004 | T-021 | backend/rules security regression paketi | `docs/architecture/T-021_BACKEND_SECURITY_REGRESSION_PAKETI_2026-03-28.md` + `functions/tests/unit/moderationSecurityRegression.test.js` + `functions/tests/rules/firestore.rules.test.js` + `functions/tests/rules/storage.rules.test.js` | `npm run build` + `npm run test:security-regressions` | Codex local review | Hazir |
| ART-005 | T-022 | startup/session/feed davranis test raporu | `docs/architecture/T-022_AUTH_SESSION_FEED_DAVRANIS_TESTLERI_2026-03-28.md` + `integration_test/auth/auth_startup_session_restore_test.dart` + `integration_test/feed/feed_primary_bootstrap_contract_test.dart` + `config/test_suites/auth_session_feed_regression.txt` + `scripts/run_auth_session_feed_regression.sh` | `dart analyze --no-fatal-warnings integration_test/core/bootstrap/test_app_bootstrap.dart integration_test/auth/auth_startup_session_restore_test.dart integration_test/feed/feed_primary_bootstrap_contract_test.dart test/unit/modules/sign_in/sign_in_application_service_test.dart test/unit/repositories/feed_home_contract_test.dart test/unit/modules/agenda/agenda_feed_application_service_test.dart test/unit/modules/short/short_feed_application_service_test.dart` + `flutter test test/unit/modules/sign_in/sign_in_application_service_test.dart test/unit/repositories/feed_home_contract_test.dart test/unit/modules/agenda/agenda_feed_application_service_test.dart test/unit/modules/short/short_feed_application_service_test.dart` + `bash -n scripts/run_auth_session_feed_regression.sh` | Codex local review | Hazir |
| ART-006 | T-024 | coverage gate policy ve cikti | `docs/architecture/T-024_COVERAGE_GATE_POLICY_2026-03-28.md` + `scripts/check_flutter_coverage.sh` + `config/quality/flutter_coverage_policy.env` + `.github/workflows/ci.yml` + `coverage/coverage_gate_report.txt` | `bash -n scripts/check_flutter_coverage.sh` + `bash scripts/check_flutter_coverage.sh /tmp/t024_coverage_pass.lcov` + `bash scripts/check_flutter_coverage.sh /tmp/t024_coverage_fail.lcov` | Codex local review | Hazir |
| ART-024 | T-014 | startup/session failure modeli ve hedefli failure testleri | `docs/architecture/T-014_STARTUP_SESSION_FAILURE_MODEL_2026-03-28.md` + `lib/Runtime/startup_session_failure.dart` + `test/unit/modules/splash/splash_bootstrap_roles_test.dart` + `test/unit/services/current_user_service_role_split_test.dart` | `dart analyze --no-fatal-warnings lib/Runtime/startup_session_failure.dart lib/Modules/Splash/splash_view.dart lib/Modules/Splash/splash_view_startup_part.dart lib/Modules/Splash/splash_startup_orchestrator.dart lib/Modules/Splash/splash_post_login_warmup.dart lib/Modules/Splash/splash_session_bootstrap.dart lib/Services/current_user_service.dart lib/Services/current_user_service_auth_role_part.dart lib/Services/current_user_service_sync_role_part.dart lib/Services/current_user_service_account_center_role_part.dart lib/Services/account_session_vault.dart test/unit/modules/splash/splash_bootstrap_roles_test.dart test/unit/services/current_user_service_role_split_test.dart` + `flutter test test/unit/modules/splash/splash_bootstrap_roles_test.dart test/unit/services/current_user_service_role_split_test.dart` | Codex local review | Hazir |
| ART-023 | T-026 | dokuman tek-kaynak guard'i, policy yuzeyi ve docs artifact'lari | `docs/architecture/T-026_DOKUMAN_TEK_KAYNAK_GUARD_2026-03-28.md` + `scripts/check_docs_single_source.sh` + `.github/workflows/ci.yml` + `docs/README.md` + `artifacts/docs_guard/*` | `bash -n scripts/check_docs_single_source.sh` + `bash scripts/check_docs_single_source.sh --against HEAD --files docs/README.md,scripts/check_docs_single_source.sh,.github/workflows/ci.yml,docs/architecture/T-026_DOKUMAN_TEK_KAYNAK_GUARD_2026-03-28.md,docs/TURQAPP_30_GUNLUK_ODAK_PLANI_2026-03-28.md` | Codex local review | Hazir |
| ART-007 | T-029 | playback/cache runtime boundary notu ve lifecycle testleri | `docs/architecture/T-029_PLAYBACK_CACHE_RUNTIME_BOUNDARY_2026-03-28.md` + `test/unit/modules/playback_runtime/playback_cache_runtime_service_test.dart` | `dart analyze --no-fatal-warnings lib/Modules/PlaybackRuntime/playback_cache_runtime_service.dart lib/Modules/Agenda/Common/post_content_base.dart lib/Modules/Agenda/Common/post_content_base_lifecycle_part.dart lib/Modules/Agenda/Common/post_content_base_playback_part.dart lib/Modules/Short/short_view.dart lib/Modules/Short/short_view_playback_part.dart lib/Modules/Short/single_short_view.dart lib/Modules/Short/single_short_view_helpers_part.dart lib/Modules/Short/single_short_view_playback_part.dart lib/Modules/Short/single_short_view_ui_part.dart lib/Modules/Short/single_short_view_controller_bootstrap_part.dart lib/Modules/Short/single_short_view_controller_sync_part.dart lib/Modules/Story/StoryViewer/story_viewer.dart test/unit/modules/playback_runtime/playback_cache_runtime_service_test.dart` + `flutter test test/unit/modules/playback_runtime/playback_cache_runtime_service_test.dart` + `bash scripts/check_architecture_guards.sh --against HEAD --files ...` | Codex local review | Hazir |
| ART-008 | T-030 | part-sprawl envanteri ve secili sadeleştirme diff'i | `docs/architecture/T-030_PART_SPRAWL_ENVANTERI_2026-03-28.md` + `lib/Modules/SignIn/sign_in_controller.dart` + `lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_library.dart` + `lib/Modules/Story/StoryRow/story_row_controller.dart` | `dart analyze --no-fatal-warnings lib/Modules/SignIn/sign_in_controller.dart lib/Modules/Profile/Settings/AdsCenter/ads_center_controller_library.dart lib/Modules/Story/StoryRow/story_row_controller.dart test/unit/modules/sign_in/sign_in_application_service_test.dart test/unit/modules/profile/ads_center_application_service_test.dart test/unit/modules/story/story_row_application_service_test.dart` + `flutter test test/unit/modules/sign_in/sign_in_application_service_test.dart test/unit/modules/profile/ads_center_application_service_test.dart test/unit/modules/story/story_row_application_service_test.dart` + `bash scripts/check_architecture_guards.sh --against HEAD --files ...` | Codex local review | Hazir |
| ART-009 | T-031 | repo surface area envanteri ve sicak yol sadeleştirme hedef listesi | `docs/architecture/T-031_REPO_SURFACE_AREA_ENVANTERI_2026-03-28.md` | `find lib -name '*.dart' | wc -l` + `python3` ile alan bazli sayim + `git diff --check` | Codex local review | Hazir |
| ART-030 | T-025 | gercek screen widget testleri ve widget-screen baglama notu | `docs/architecture/T-025_WIDGET_TESTLERI_EKRAN_DAVRANISI_2026-03-28.md` + `test/widget/screens/sign_in_test.dart` + `test/widget/screens/chat_search_widget_test.dart` | `dart analyze --no-fatal-warnings test/widget/screens/sign_in_test.dart test/widget/screens/chat_search_widget_test.dart` + `flutter test test/widget/screens/sign_in_test.dart test/widget/screens/chat_search_widget_test.dart` | Codex local review | Hazir |
...
| DEBT-001 | Debt | Orta | T-030, F2-011, F3-003, F3-004, M1-001, M1-002, M1-003, M1-004 | Kapandi | `M1-004` ile tracked mikro part dosyalari icin repo toplam butcesi ve secili sicak kume guard'lari CI'ya baglandi; `micro_part_total=613`, `cache_snapshot_hot=0`, `startup_auth_session_hot=0`, `profile_social_hot=4` ve `feed_playback_hot=37` degerleri tekrar buyurse guard fail veriyor, buyuk kalan kumeler de watch hedefi olarak raporlaniyor |
...
## Mini Faz 1 Resmi Plan

Bu mini faz, yalnizca acik `DEBT-001` kaydini cache/snapshot sicak kumesinde
kontrollu ve dar kapsamli bir dalga ile ele almak icin tanimlandi.

Toplam:

- is sayisi: `4`
- puan: `14`
- plan sagligi gozden gecirme tetigi: `4`
...
| M1-004 | Part-sprawl debt kapanis guard'i ve final olcum | `DEBT-001` | M1-002, M1-003 | M/2 | Tamamlandi |
...
| M1-ART-004 | `docs/testing/mini_faz_part_sprawl_closure_2026-03-29.md` | Dolu | `M1-004` ile tracked mikro part dosyalari icin `micro_part_total`, `cache_snapshot_hot`, `startup_auth_session_hot`, `profile_social_hot` ve `feed_playback_hot` budget guard'i eklendi; `Education`, `Core Services` ve `Profile Settings/Admin` da watch hedefi olarak raporlaniyor |
