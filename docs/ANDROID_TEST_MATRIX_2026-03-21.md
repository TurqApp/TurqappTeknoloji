...
| Practice exams | `Online Sinav`, `saved`, `my exams`, `type list`, `sonuclarim` | manuel + omurga sweep | `ANDROID_ACIK` | `Online Sinav` liste ve `Basvuru/Hemen Basvur` satiri stabil; card/detail/apply akisinda ikinci sweep gerekli |
